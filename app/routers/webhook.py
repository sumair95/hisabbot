...
# Shop-rename intent is now classified by the LLM extractor
# (see app/prompts/extraction.py — Intent.SETTINGS_CHANGE).
...
async def _process_one_message(msg: dict, value: dict) -> None:
    ...
    # Shop-name rename is handled by the LLM (Intent.SETTINGS_CHANGE).
